...
export const registerPersonnel = async (role: string, step1Data: any, step2Data: any, step3Data: any) => {
  ...
  if (role === 'ambulance') {
    ...
    roleData = {
      ...
      capacity_icu_total: parseInt(step3Data.icuTotalBeds) || 0,
      capacity_icu_available: parseInt(step3Data.icuAvailableBeds) || 0,
      staff_count: parseInt(step3Data.staffCount) || 0,
